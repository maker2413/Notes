...
#+last_modified: [2022-10-15 Sat 10:51]
...
from text. Lets look at a quick example of what ~awk~ does. Lets start by
...
With that out of the way lets dive into what I mean when I say pattern:
