...
#+last_modified: [2022-03-11 Fri 15:18:41]
#+filetags: Tool
...
* Yaml Datatypes
  We briefly covered it up above but lets go over the specifics of what
...
** Numeric Types
   ...
   examples above but lets look at what Integer types are supported:
   #+begin_src yaml
     ---
     foo: 231234
     bar: 0xDE23
